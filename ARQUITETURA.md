...
| 11 | Inventário & Rastreio | `/inventario` | 🟡 schema + vitrine | — |
| 12 | Expedição | `/expedicao` | 🟡 schema + vitrine | — |
| 13 | Distribuição & Last Mile | `/distribuicao` | 🟡 schema + vitrine | — |
...
- **Demand Planning / Inventário / Expedição / Distribuição / YMS**: telas CRUD reais (schema pronto).
- **LOGIA**: Edge `logia-brain` (geração fina) + secrets.
- Geral: seed de dados demo, deploy (Netlify), telas dos vols 05/07/11/12/13.
