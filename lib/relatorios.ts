...
export const RELATORIOS: Relatorio[] = [
  ...
  { slug: "fluxo-caixa", title: "Fluxo de Caixa", icon: "💵", rpc: "rel_fluxo_caixa", categoria: "Comercial & Financeiro", periodo: true, diasPadrao: 90, resumo: "Contas a pagar e a receber, saldo projetado, vencidos e a vencer — com os próximos vencimentos." },
  { slug: "crm", title: "CRM — Segmentos & LTV", icon: "👤", rpc: "rel_crm", categoria: "Comercial & Financeiro", periodo: true, diasPadrao: 365, resumo: "Compradores por segmento (novo/recorrente/VIP), LTV, recompra e melhores clientes — cruzando as fichas com os pedidos." },
  { slug: "catalogo", title: "Catálogo — Estoque & Reposição", icon: "▤", rpc: "rel_catalogo", categoria: "Operação & Logística", periodo: false, diasPadrao: 0, resumo: "Valor de estoque por categoria, produtos abaixo do mínimo e o que precisa repor." },
  { slug: "metas", title: "Metas & Desempenho", icon: "🎯", rpc: "rel_metas", categoria: "Inteligência & Governança", periodo: true, diasPadrao: 30, resumo: "Progresso de cada meta (receita, pedidos, entregas, ticket, comissão) contra o realizado apurado dos pedidos." },
  ...
  // ── Torre de Controle Correios ──────────────────────────────────────────
  { slug: "torre-correios", title: "Torre de Controle — Correios", icon: "🗼", rpc: "rel_torre_correios", categoria: "Operação & Logística", periodo: true, diasPadrao: 90, resumo: "Painel executivo do ciclo Correios: funil por etapa (aguardando etiqueta → etiquetado → postado → em trânsito → entregue), exceções (sem CEP, bloqueados, devolvidos), SLA vencido, sem rastreio e pedidos críticos em risco de extravio." },
  // ── Onda 7 ──────────────────────────────────────────────────────────────
  { slug: "recuperacao", title: "Recuperação de Vendas", icon: "🎣", rpc: "rel_recuperacao", categoria: "Comercial & Financeiro", periodo: true, diasPadrao: 30, resumo: "Pedidos que quase viraram venda — boleto/Pix não pago, canceladas e abandonadas — em fila acionável com contato do comprador. Dinheiro que escapa hoje." },
  { slug: "impostos", title: "Provisão de Impostos (DAS)", icon: "🧾", rpc: "rel_impostos", categoria: "Comercial & Financeiro", periodo: true, diasPadrao: 365, resumo: "Estimativa do DAS do Simples Nacional sobre a receita real: quanto separar por mês, alíquota efetiva e apuração mensal. Ajustável por empresa." },
  { slug: "reenvios", title: "Reenvios & Custo de Retrabalho", icon: "↩️", rpc: "rel_reenvios", categoria: "Operação & Logística", periodo: true, diasPadrao: 90, resumo: "Reenvios por motivo e UF, quanto foi recuperado do cliente (cobrança Asaas), cobranças pendentes e compradores reincidentes." },
  { slug: "chargeback-radar", title: "Radar de Chargeback & Reembolso", icon: "🚨", rpc: "rel_chargeback_radar", categoria: "Inteligência & Governança", periodo: true, diasPadrao: 90, resumo: "Estornos, disputas e chargebacks por plataforma e UF, valor estornado, taxa de estorno e CPFs reincidentes — base antifraude." },
  { slug: "recompra", title: "Recompra & Reposição prevista", icon: "🔁", rpc: "rel_recompra", categoria: "Comercial & Financeiro", periodo: true, diasPadrao: 365, resumo: "Recorrência dos clientes (suplemento acaba em ~30–60 dias): quem está na hora de reabastecer, melhores clientes por LTV e taxa de recompra." },
];
