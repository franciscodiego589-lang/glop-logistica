...
export const NAV: NavItem[] = [
  ...
  { slug: "visibilidade", label: "Visibilidade da Cadeia (SCVP)", icon: "🛰", group: "Visão Geral & Inteligência", vol: 48, description: "Rastreamento ponta a ponta, eventos normalizados, ETA inteligente, exceções, compartilhamento" },
  ...
  { slug: "prepostagem", label: "Prepostagem Correios", icon: "📮", group: "Transporte & Pátio", vol: 55, description: "Pré-postagens (PPN), rastreio dos objetos (SRO), conferência de postagem, correções de CEP, logs automáticos" },
  { slug: "correios-central", label: "Correios — Central Única", icon: "🏤", group: "Transporte & Pátio", vol: 66, description: "TODAS as ferramentas dos Correios num só lugar: prepostagem, rastreio (SRO), conferência, correção de CEP, contratos/remetente, credenciais da API e logs" },
  { slug: "integracoes-lojas", label: "Puxar Pedidos de Lojas (Monetizze…)", icon: "🛒", group: "Fluxo Operacional", vol: 53, description: "Cole a chave da API da plataforma (Monetizze/Hotmart/Kiwify/Shopify/ML) e puxe todos os pedidos. Ingestão sem duplicar, multi-produtor" },
  { slug: "coproducao", label: "Coprodução & Split", icon: "🤝", group: "Fluxo Operacional", vol: 54, description: "Coprodutores, regras de comissão, apuração de vendas, repasses por período e split de pagamento (AppMax)" },
  { slug: "ecommerce-hub", label: "E-commerce — Lojas & Chaves API", icon: "🛍", group: "Fluxo Operacional", vol: 67, description: "Conecte qualquer e-commerce (Shopify, WooCommerce, Nuvemshop, VTEX, Tray, Yampi…): cole a chave da API, teste a conexão e puxe os pedidos" },
  { slug: "financeiro-dre", label: "Financeiro — DRE", icon: "💵", group: "Fluxo Operacional", vol: 68, description: "Demonstrativo de resultado com dados reais: receita bruta, comissões de coprodução, líquido da empresa, margem, ticket médio, receita por estado e canal" },
  { slug: "rastreio", label: "Portal de Rastreio (público)", icon: "🌍", group: "Transporte & Pátio", vol: 69, description: "Página pública que o comprador usa pra acompanhar o pedido pelo código de rastreio — cobre pedidos logísticos e pedidos de loja (Correios)" },
  { slug: "planos-precos", label: "Planos & Preços do Produtor", icon: "💰", group: "Fluxo Operacional", vol: 57, description: "Planos por plataforma, tabelas de preço por produto/faixa, regras de embalagem e faixas de frete/peso" },
  { slug: "comunicacao", label: "Comunicação (Email/WhatsApp)", icon: "📣", group: "Fluxo Operacional", vol: 58, description: "Logs de e-mail e WhatsApp de rastreio ao comprador + templates editáveis (email/WhatsApp/carteiro)" },
  { slug: "webhooks-integracoes", label: "Webhooks & Integrações", icon: "🔗", group: "Fluxo Operacional", vol: 59, description: "Webhooks de saída do produtor e entregas, logs SisLógica, logs de API e de webhook das plataformas" },
  { slug: "envios-rastreamento", label: "Envios & Rastreamento", icon: "📦", group: "Transporte & Pátio", vol: 60, description: "Remessas postadas e último status, eventos de rastreio (SRO), destinatários, carteiro ausente, reenvios" },
  { slug: "estoque-logistico", label: "Estoque Logístico", icon: "🗄", group: "Estoque & Armazém", vol: 61, description: "Produtos, locais, movimentos, baixa automática e registros de estoque (Logística Rodrigo)" },
  { slug: "vhsys", label: "Integração VHSYS", icon: "🏬", group: "Estoque & Armazém", vol: 62, description: "Saldos e movimentos de estoque sincronizados com o VHSYS e locais de estoque" },
  { slug: "nfe", label: "NFe (Emissões)", icon: "🧾", group: "Estoque & Armazém", vol: 63, description: "Emissões de NFe via VHSYS — status, DANFE/XML e vínculo de baixa de estoque por produto" },
  ...
  { slug: "aduana", label: "Aduana (CMS)", icon: "🛃", group: "Comércio Exterior", vol: 45, description: "Desembaraço, canais (verde/amarelo/vermelho), documentação, inspeções, liberação, recintos alfandegados" },
